...
COMMENT ON COLUMN review.file2 is '메인 이미지';
COMMENT ON COLUMN review.file2saved is '실제 저장된 메인 이미지';
COMMENT ON COLUMN review.thumb2 is '메인 이미지 Preview';
COMMENT ON COLUMN review.size2 is '메인 이미지 크기';
