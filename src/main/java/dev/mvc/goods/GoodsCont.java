...
//      
//      if (cnt == 1) {
//        this.dogProc.update_cnt_add(goodsVO.getItemno());
//        mav.addObject("code", "create_success");
//          // dogProc.increaseCnt(goodsVO.getItemno()); // 글수 증가
//      } else {
...
//
//    DogVO dogVO = this.dogProc.read(goodsVO.getItemno()); // 그룹 정보 읽기
//    mav.addObject("dogVO", dogVO); 
//    
//    // 회원 번호: adminno -> 
...
// /**
//  * 목록 + 검색 + 페이징 지원
//  * http://localhost:9091/goods/list_by_dogno.do?dogno=1&word=스위스&now_page=1
//  * 
//  * @param dogno
//  * @param word
//  * @param now_page
//  * @return
//  */
// @RequestMapping(value = "/goods/list_by_dogno.do", method = RequestMethod.GET)
// public ModelAndView list_by_dogno_search_paging(GoodsVO goodsVO) {
//
//   ModelAndView mav = new ModelAndView();
//
//   // 검색된 전체 글 수
...
//   ArrayList<GoodsVO> list = goodsProc.list_by_dogno_search_paging(goodsVO);
//   mav.addObject("list", list);
//
//   DogVO dogVO = dogProc.read(goodsVO.getDogno());
//   mav.addObject("dogVO", dogVO);
//
//   /*
...
//    */
//   String paging = goodsProc.pagingBox(goodsVO.getDogno(), goodsVO.getNow_page(), goodsVO.getWord(), "list_by_dogno.do");
//   mav.addObject("paging", paging);
//
//   // mav.addObject("now_page", now_page);
//   
//   mav.setViewName("/goods/list_by_dogno_search_paging");  // /goods/list_by_dogno_search_paging.jsp
//
//   return mav;
// }
// 
// /**
//  * 목록 + 검색 + 페이징 + 그리드(Grid)
//  * http://localhost:9091/goods/list_by_dogno_grid.do?dogno=1&word=스위스&now_page=1
//  * 
//  * @param dogno
//  * @param word
//  * @param now_page
//  * @return
//  */
// @RequestMapping(value = "/goods/list_by_dogno_grid.do", method = RequestMethod.GET)
// public ModelAndView list_by_dogno_search_paging_grid(GoodsVO goodsVO) {
//
//   ModelAndView mav = new ModelAndView();
//
//   // 검색된 전체 글 수
...
//    * @return 페이징용으로 생성된 HTML/CSS tag 문자열
//    */
//   String paging = goodsProc.pagingBox(goodsVO.getItemno(), goodsVO.getNow_page(), goodsVO.getWord(), "list_by_dogno_grid.do");
//   mav.addObject("paging", paging);
//
//   // mav.addObject("now_page", now_page);
//   
//   mav.setViewName("/goods/list_by_dogno_search_paging_grid");  // /goods/list_by_dogno_search_paging_grid.jsp
//
//   return mav;
// }
// 
...
//   
//   DogVO dogVO = this.dogProc.read(goodsVO.getDogno());
//   mav.addObject("dogVO", dogVO);
//   
...
//     mav.addObject("dogno", goodsVO.getDogno());
...
//
//   // URL에 파라미터의 전송
//   // mav.setViewName("redirect:/goods/read.do?goodsno=" + goodsVO.getGoodsno() + "&dogno=" + goodsVO.getDogno());             
//   return mav; // forward
//   }  
// 
// 
...
//   
//   this.dogProc.update_cnt_sub(goodsVO.getDogno());    
//       
//   // -------------------------------------------------------------------------------------
...
//   mav.addObject("dogno", goodsVO.getDogno());
//   mav.addObject("now_page", now_page);
//   mav.setViewName("redirect:/goods/list_by_dogno.do"); 
//   
//   return mav;
// }   
// 
// // 특정 카테고리 개수
// // http://localhost:9091/goods/count_by_dogno.do?dogno=1
// @RequestMapping(value = "/goods/count_by_dogno.do", method = RequestMethod.GET)
// public String count_by_dogno(int dogno) {
//   System.out.println("-> count: " + this.goodsProc.count_by_dogno(dogno));
//   return "";
// }
///**
// * 특정 카테고리에 속한 레코드 삭제
...
// * @return
// */
// // http://localhost:9091/goods/delete_by_dogno.do?dogno=1
// // 파일 삭제 -> 레코드 삭제
// @RequestMapping(value = "/goods/delete_by_dogno.do", method = RequestMethod.GET)
// public String delete_by_dogno(int dogno) {
//   ArrayList<GoodsVO> list = this.goodsProc.list_by_dogno(dogno);
//   
...
//     // -------------------------------------------------------------------
//   }
//   System.out.println("-> count: " + this.goodsProc.delete_by_dogno(dogno));
//   return "";
// }
// 
//}
