...
<c:set var="thumb1" value="${recipeVO.thumb1.toLowerCase() }" />
...
<DIV class='title_line'><A href="./list_by_itemno_search_paging.do?itemno=${itemno }" class='title_link'>${itemVO.name }</A> > 파일 수정</DIV>
