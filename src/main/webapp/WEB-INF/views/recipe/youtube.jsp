...
<DIV class='content_body'>
  <ASIDE class="aside_right">
    ...
    <span class='menu_divide' >│</span>
    <A href="./list_by_itemno_grid.do?itemno=${recipeVO.itemno }&now_page=${param.now_page == null ? 1 : param.now_page}&word=${param.word }">갤러리형</A>
  </ASIDE>
  ...
  <FORM name='frm_youtube' method='POST' action='./youtube.do'>
    <input type="hidden" name="recipeno" value="${param.recipeno }">
    
    <div>
       <label>Youtube 스크립트</label>
       <textarea name='youtube' class="form-control" rows="12" style='width: 100%;'>${recipeVO.youtube }</textarea>
    </div>
  ...
  <DIV style="text-align: center;">
      ...
      <IMG src='/recipe/images/youtube01.jpg' style='width: 60%;'><br><br>
      <IMG src='/recipe/images/youtube02.jpg' style='width: 60%;'><br>
  </DIV>
