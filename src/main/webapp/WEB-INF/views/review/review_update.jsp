...
<li class="li_none">
  ...
  <fieldset class="fieldset_basic">
    ...
    <input type="hidden" id="star-rating" name="ratingValue" value=""/>
      ...
      <!-- 댓글 평점 별  -->
        ...
        <img src="/review/images/reviewst.png" class="icon3" >리뷰 수정
  ...
  <script>
    ...
    <div style="display: flex; align-items: center; table-layout: fixed; margin-left: 60%;">
      ...
      <button type='submit' class="btn btn-outline-dark btn-sm" style="table-layout: fixed;" onclick="checkRatingValue(event)">리뷰 수정</button>
