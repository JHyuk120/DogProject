  ...
  <DIV class='content_body'> 
    <DIV style='width: 40%; margin: 0px auto;'>
      <FORM name='frm' method='POST' action='./login.do'>
        ...
        <div class="form_input">
          <button type="submit" class="btn btn-outline-info btn-sm">로그인</button>
          <button type='button' id='btn_create' class="btn btn-outline-info btn-sm">회원가입</button>
          <button type='button' id='btn_loadDefault' class="btn btn-outline-info btn-sm">테스트 계정</button>
        </div>   
