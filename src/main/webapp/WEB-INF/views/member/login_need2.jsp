              ...
              success: function(rdata) { // 응답이 온경우
                ...
                if (rdata.cnt == 1) {
                 ...
                 // $('#div_login').hide(); // 로그인폼 감추기
                  //alert('로그인 성공');
                  $('#login_yn').val('Y');
                  window.location.href = "/member/delete_mem.do";
...
<c:import url="/menu/top.do" />
  ...
  <DIV class='message'>
    ...
    <DIV style='width: 40%; margin: 0px auto;'>
      ...
      <button type="button"  id='btn_login' style="width:150px; height:45px; margin-right:90px; "class="btn btn-dark" onclick="login_ajax()">로그인</button>
