...
<DIV class='content_body'>
  ...
  <DIV style="text-align: right; clear: both;">  
    <form name='frm' id='frm' method='get' action='./list_by_qnano.do'>
...
<c:forEach var="qnaVO" items="${list}" varStatus="loop">
        ...
        <c:set var="noticeno" value="${qnaVO.qnano }" />
        <c:set var="rdate" value="${qnaVO.rdate.substring(0, 10)}" />
         
  <tr style="height: 50px;">
    <td style='vertical-align: middle; text-align: center;'>
      <a href="./read.do?noticeno=${qnano}">
        ${list.size() - loop.index}
      </a>
    </td>
      <td style='vertical-align: middle; text-align: center;'>
        <a href="./read.do?noticeno=${qnano}" style="display: block;">
