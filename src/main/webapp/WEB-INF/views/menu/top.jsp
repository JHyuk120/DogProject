                    ...
                    <c:choose>
                      <c:when test="${sessionScope.id == null && sessionScope.admin_id == null}">
                        <a class="nav-link" href="/member/login.do">
                          <img src="/menu/images/lock.png" class="icon" style='margin-left:30px'>&nbsp;login</a>
                      </c:when>
                      <c:otherwise>
                        <c:choose>
                          <c:when test="${sessionScope.admin_id == null}">
                            <a class="nav-link" href='/member/logout.do'>
                              <img src="/menu/images/unlock.png" class="icon" style='margin-left:10px'>&nbsp; logout</a>
                          </c:when>
                          <c:otherwise>
						    ...
						    <c:when test="${sessionScope.admin_id == null}">
						        <li class="nav-item dropdown">
						            ...
						            <a class="nav-link dropdown-toggle" data-toggle="dropdown" href="#">
						                <img src="/menu/images/pcircle.svg" class="icon" style='margin-left:20px'>&nbsp;마이페이지</a>
